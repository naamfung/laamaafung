...
# BUILD_UI=ON 编译界面
cmake -B "$BUILD_DIR" -DGGML_CUDA=ON -DGGML_NATIVE=ON -DGGML_CUDA_FA=ON -DGGML_CUDA_FA_ALL_QUANTS=ON -DCMAKE_BUILD_TYPE=Release -DLLAMA_KVMEM=ON -DLLAMA_KVMEM_ROOT="$PWD"
