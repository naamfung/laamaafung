...
// Restored from v22 for KVMem: the custom decoder sets llama_batch::logical_pos
// ("unique cache row IDs") BEFORE llama_decode runs, which the plain helper cannot do.
