...
// Prefill GQA (Q->ne[1] > 4, gqa_ratio >= 8, ncols2 == 8) tile sizes.
// Only ncols1 = 16 (ncols = 128) is compiled: shared_Q = ncols*(DKQ/2+4)*sizeof(half2)
// stays within 100 KB for both DKQ=128 (34 KB) and DKQ=256 (68 KB). Larger ncols1 would
// push shared_Q past the Ampere 100 KB limit at DKQ=256 (132 KB for ncols=256) and
// past Turing's 64 KB limit even at DKQ=128 (68 KB for ncols=256). Q->ne[1] > 16
// falls through to the ncols2 == 1 MHA path inside prefill().
#define DECL_FATTN_MMA_TURBO_PREFILL_GQA(DKQ, DV, tK, tV)  \
    extern DECL_FATTN_MMA_TURBO_CASE(DKQ, DV, 16, 8, tK, tV); \
...
DECL_FATTN_MMA_TURBO_PREFILL_GQA(128, 128, GGML_TYPE_TURBO4_0, GGML_TYPE_TURBO4_0);
...
DECL_FATTN_MMA_TURBO_PREFILL_GQA(128, 128, GGML_TYPE_TURBO3_0, GGML_TYPE_TURBO3_0);
...
DECL_FATTN_MMA_TURBO_PREFILL_GQA(128, 128, GGML_TYPE_TURBO2_0, GGML_TYPE_TURBO2_0);
